...
<body>
    ...
    <!--视频右侧导航end-->
<link rel="stylesheet" href="../Public/Css/Content/specialist.css">
<div class="container">
    <section class="special_list">
        <?php if(is_array($rows)): foreach($rows as $key=>$row2): ?><figure>
                <a href="__URL__/specialinfo/id/<?php echo ($row2['id']); ?>">
                    <img src="<?php echo ($row2['img']); ?>">
                    <figcaption>
                        <p><?php echo ($row2['name']); ?></p>
                        <p class="describe">
                            <?php echo mb_substr($row2['describe'],0,40,'utf-8');?>
                        </p>
                    </figcaption>
                </a>
