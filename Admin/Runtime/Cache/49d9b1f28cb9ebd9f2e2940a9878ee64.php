...
<div class="container">
    <div class="row">
        ...
        <h1><span class="glyphicon glyphicon-wrench"></span>修改用户信息</h1>
        <form action="__URL__/update" method="post" enctype="multipart/form-data" target="">
            <div class="form-group">
                <label> 用户名</label>
                <input type="text" class="form-control" name="username" placeholder="用户名" value="<?php echo ($row['username']); ?>" disabled="disabled">
            </div>
